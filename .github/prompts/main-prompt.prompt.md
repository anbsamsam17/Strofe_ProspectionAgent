---
name: main-prompt
description: "Prompt principal du projet Agent IA - Prospection Bilan Carbone. Utilise /main-prompt dans Copilot Chat pour démarrer la tâche principale."
---

# Prompt Principal — Agent IA - Prospection Bilan Carbone
